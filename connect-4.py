...
class Node:
    def __init__ (self, game_statem, player , parent = None , move = None):
        self.game_statem = game_statem
        self.player = player  
        self.parent = parent
        self.move = move
        self.children = {}  
...
def utc(board, next_player, rollouts, verbose):
    game = board
    root = Node(game, next_player)
...
def main():
    ...
    rollouts = 0
    verbose = False
    utc(board, next_player,rollouts,verbose)
